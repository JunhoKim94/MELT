...
class MaterialsTextProcessor:
    ...
    def tokenize(self, text, split_oxidation=True, keep_sentences=False):
    ...
    def custom_preprocess(self, tokens, exclude_punct=False, convert_num=True, normalize_materials=True, remove_accents=True,
