...
if preds_save_dir:
    ...
    with open(p, "a") as f:
        f.write(f'{args.load_weights} | {dataset_name} | Best_val : {best_val} | Best_test : {np.mean(best_test_acc_list)} | Val {best_val_acc_list} | Test {best_test_acc_list} | Other Val {best_val_oth_list} | Test {best_test_oth_list} | Best lr : {best_lr} | best_val : {best_val_result} | best_test : {best_test_result} | to_noramlize : {to_normalize}\n')
